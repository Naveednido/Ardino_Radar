...
//**********
    ...
    public void textfun() {
        textAlign(CENTER);
        fill(0xff06BCB7);
        text("Range in Centi-meters" + info1, width / 2, height - height / 1.11f);
    ...
    public void radar() {
        background(200);
        myChart.setColorBackground(color(255 - info1, 25, 25));
        myChart.setColorForeground(color(25));
        myChart.push("incoming", info1);
    }
