...
public class zealotbt1 extends PApplet {
...
//with the list of paired devices
        ...
        {
            int a = color(255,0,0);                      //the color for each button of the interface
            int b = color(255,0,0);
            int c = color(255,0,0);
            int d = color(255,0,0);
            int e = color(165,8,27);
            int f = color(165,8,27);
            int g = color(165,8,27);
            int h = color(165,8,27);
            int i = color(18,21,121);
            int j = color(255,255,255);
            int k = color(255,255,255);
            int l = color(0,0,0);
